...
这篇文章，是[上一篇 Jenkins 部署 远程调试](https://www.jianshu.com/p/16c92eefd88c)的继续，
# 为了解决的问题
为了解决这样的一个问题：假设在用户 abc 的home 目录 **/home/abc** 下有两个tomcat，分别放在了
**apache-tomcat-8.5.29_projects** 和 **apache-tomcat-8.5.29_Jenkins** 目录下。

一个监听7070端口，一个监听8080端口。

**调用 /home/abc/apache-tomcat-8.5.29_projects/bin/shutdown.sh 会把 在 apache-tomcat-8.5.29_Jenkins 目录启动的tomcat也杀掉**。

虽然有简单的脚本 **start.sh** 和 **stop.sh** 可以解决这个问题。但是这个两个脚本有个小问题：CATALINA_HOME 和 CATALINA_BASE 路径是写死的。这样的话，如果在多个地方部署的话，需要修改多次。

假如有一个脚本，跟start.sh 和stop.sh 一样，放在了 apache-tomcat-8.5.29/bin 目录下，但是不用写死路径，而是以当前脚本的路径为启动，自己去判断 CATALINA_HOME 和 CATALINA_BASE 就好了。

start.sh
```sh
export JAVA_HOME=/usr/java/jdk1.8.0_152
export CATALINA_HOME=/home/abc/apache-tomcat-8.5.29_projects
export CATALINA_BASE=/home/abc/apache-tomcat-8.5.29_projects
...
```
# 脚本
这个脚本是根据ubuntu自带的  /etc/init.d/tomcat8 修改而来。
...
# 使用效果
```sh
aa@ubuntu:~/projects/bin$ ./tomcat_control.sh status
tomcat of /home/aa/projects is running with pid 14111


aa@ubuntu:~/projects/bin$ ./tomcat_control.sh stop
Stopping Tomcat servlet engine in /home/aa/projects tomcat
Using CATALINA_BASE:   /home/aa/projects
Using CATALINA_HOME:   /home/aa/projects
Using CATALINA_TMPDIR: /tmp/tomcat-projects
Using JRE_HOME:        /usr/lib/jvm/java-8-openjdk-amd64
Using CLASSPATH:       /home/aa/projects/bin/bootstrap.jar:/home/aa/projects/bin/tomcat-juli.jar
Using CATALINA_PID:    /home/aa/projects/conf/tomcat_pid.pid
...
aa@ubuntu:~/projects/bin$ ./tomcat_control.sh status
tomcat of /home/aa/projects not runing....


aa@ubuntu:~/projects/bin$ ./tomcat_control.sh start
Starting Tomcat servlet engine in /home/aa/projects tomcat
/home/aa/projects/conf/tomcat_pid.pid does not exists
Using CATALINA_BASE:   /home/aa/projects
Using CATALINA_HOME:   /home/aa/projects
Using CATALINA_TMPDIR: /tmp/tomcat-projects
Using JRE_HOME:        /usr/lib/jvm/java-8-openjdk-amd64
...
aa@ubuntu:~/projects/bin$ ./tomcat_control.sh status
tomcat of /home/aa/projects is running with pid 94702
aa@ubuntu:~/projects/bin$
